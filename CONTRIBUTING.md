# Contributing to Bitcore-Zula

We're working hard to make *bitcore-zula* the most powerful JavaScript library for working with Zula. Our goal is to have *bitcore-zula* be a library that can be used by anyone interested in Zula, and to level expertise differences with great design and documentation.
...
These are some global design goals in bitcore-zula to which any change should adhere.
...
```sh
git remote add zula git@github.com:zuladev/bitcore-zula.git
git pull --rebase zula master
```
...
```
Finally go to [github.com/zuladev/bitcore-zula](https://github.com/zuladev/bitcore-zula) in your web browser and issue a new pull request.
...
[github.com/zuladev/bitcore-zula/issues](https://github.com/zuladev/bitcore-zula/issues).
